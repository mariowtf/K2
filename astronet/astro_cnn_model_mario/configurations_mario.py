...
from astronet.astro_model_mario import configurations_mario as parent_configs
...
def local_global():
  ...
  config["hparams"]["num_pre_logits_hidden_layers"] = 4 # 4
  config["hparams"]["pre_logits_hidden_layer_size"] = 512 # 512
  return config
