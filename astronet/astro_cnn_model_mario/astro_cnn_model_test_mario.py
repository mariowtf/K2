...
from astronet.astro_cnn_model_mario import configurations_mario
from astronet.ops import input_ops
from astronet.ops import testing
from astronet.util import configdict


class AstroCNNModelTestMario(tf.test.TestCase):
  ...
  def testOneTimeSeriesFeature(self):
    ...
    model = astro_cnn_model_mario.AstroCNNModel(features, labels, config.hparams,
